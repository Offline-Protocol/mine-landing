  ...
  <div class="container">
    <div class="card">
      <div class="card-body">
        ...
        <div class="invite">
          ${hasReferral
            ? `<h2>You're in</h2><p>${safeUsername ? '<strong>@' + safeUsername + '</strong> invited you to' : 'A friend invited you to'} help build the mesh. Connect with nearby devices, complete missions, and earn rewards for growing the network.</p>`
