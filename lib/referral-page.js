...
<head>
  ...
  <meta property="og:image" content="https://mine.offlineprotocol.com/icon.png">
  ...
  <div class="container">
    <div class="card">
      <div class="card-body">
        ...
        <div class="invite">
          ${hasReferral
            ? '<h2>You\'re in</h2><p>A friend invited you to help build the mesh. Connect with nearby devices, complete location missions, and earn rewards for growing the network.</p>'
            : '<h2>Start Mining</h2><p>Help build the world\'s largest mesh network. Connect with nearby devices, complete location missions, and earn rewards for growing the network.</p>'
          }
        </div>
