...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .cta:hover { background: #2558d4; animation: none; }
  ...
  <div class="container">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="invite">
          ${hasReferral
            ? '<h2>You\'ve been invited</h2><p>Someone wants you to join their mesh network. Download Mine and start earning rewards together.</p>'
            : '<h2>Join the Network</h2><p>Earn rewards by building the world\'s largest decentralized mesh network.</p>'
          }
        </div>
